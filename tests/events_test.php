...
class assignsubmission_filetypes_events_testcase extends advanced_testcase {
    ...
    protected function setUp() {
        ...
        $dummy = (object) array(
            ...
            'component' => 'assignsubmission_filetypes',
            'filearea' => ASSIGNSUBMISSION_FILETYPES_FILEAREA,
        ...
        $this->files = $fs->get_area_files($this->context->id, 'assignsubmission_filetypes', ASSIGNSUBMISSION_FILETYPES_FILEAREA,
