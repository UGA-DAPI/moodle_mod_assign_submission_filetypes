 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class restore_assignsubmission_filetypes_subplugin extends restore_subplugin {
     ...
     * @return void
     */
    public function process_assignsubmission_filetypes_submission($data) {
        global $DB;
        ...
        $DB->insert_record('assignsubmission_filetypes', $data);

        $this->add_related_files('assignsubmission_filetypes',
                                 'submission_files',
                                 'submission',
                                 null,
                                 $oldsubmissionid);
