 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class backup_assignsubmission_filetypes_subplugin extends backup_subplugin {
    ...
    protected function define_submission_subplugin_structure() {
        ...
        $subpluginelement->set_source_table('assignsubmission_filetypes',
                                            array('submission' => backup::VAR_PARENTID));

        // The parent is the submission.
        $subpluginelement->annotate_files('assignsubmission_filetypes',
                                          'submission_files',
                                          'submission');
        return $subplugin;
    }
